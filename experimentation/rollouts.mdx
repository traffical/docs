...
A **rollout** is a gradual increase in traffic for a new parameter value. Use rollouts when you want to ship a change carefully: start with a small slice, watch for problems, and ramp up automatically when the signal looks good.
...
| `minimumExposures` | Required exposure events before evaluation |
