...
| `ucb1` | Upper Confidence Bound. Optimistic exploration that naturally decreases over time. | A deterministic, parameter-free explorer — pair with conversion-rate goals |
