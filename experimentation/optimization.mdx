...
| Knob | What it does |
|------|--------------|
| `minExposuresBeforeShift` | The engine won't change allocations until the policy has seen at least this many total exposures across all allocations. Prevents premature shifts on noisy early data. |
