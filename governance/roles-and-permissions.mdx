---
title: "Roles, teams & API key scopes"
...
<Frame caption="The Create API Key dialog">
  <img src="/images/placeholders/create-api-key-dialog.png" alt="Create API Key dialog with the key-type preset dropdown open showing the SDK, Management, Lifecycle Operate, and Full Access presets" />
</Frame>
