...
`"decision"` is useful when the treatment is below the fold — you want to record the decision but only count exposure once the user actually sees the change.
