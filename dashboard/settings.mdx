...
| Field | Description |
|-------|-------------|
| **Type** | `Server` (`sk_...`) or `Public` (`pk_...`) — see [Projects & environments](/concepts/projects-and-environments#api-keys) |
...
Server keys are shown once at creation. Copy them then — they can't be retrieved later. If you lose one, revoke it and create a new one.
