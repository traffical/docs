...
- **Optimization (adaptive policies)** — the estimated value of adaptive traffic optimization, versus a uniform split (and versus control where that comparison is causal). Also display-only, never summed into the totals.
