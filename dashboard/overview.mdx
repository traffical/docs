...
The dashboard lives at [dashboard.traffical.io](https://dashboard.traffical.io). It's where you create projects, define parameters, run experiments, watch metrics, and manage everything that doesn't fit in code.
