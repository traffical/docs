...
[assignment events](/concepts/terminology#assignment-events), sample-ratio mismatches, freshness gaps, breached
...
- The **Overview** tab shows a compact health hero that auto-collapses when
  ...
  **Live allocation** digest also shows traffic share and assignment events
  ...
  at a glance.
- The **Diagnostics** tab (between **Measurement** and **Decision log**) shows
