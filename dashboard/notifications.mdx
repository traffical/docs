...
| **Experiment** | Measurement readouts: a metric reaches [significance](/statistics/significance) (win or loss), or a policy is ready to resolve. |
...
<CardGroup cols={2}>
  ...
  <Card title="Changes" icon="git-branch" href="/dashboard/changes">
    Where measurement and lifecycle notifications link to.
  </Card>
