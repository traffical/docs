...
### Attribution
Connecting a [track event](#track-event) to the [decision](#decision) that preceded it. Done via `decisionId` (preferred) or time-window fallback. → [Decisions & attribution](/concepts/assignments)
