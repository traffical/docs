...
<Frame caption="In-flight and optimization blocks, separated from realized totals">
  <img src="/images/placeholders/impact-inflight-optimization.png" alt="In-flight experiment rows and always-on optimization block rendered apart from realized totals" />
</Frame>
