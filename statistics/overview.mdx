...
<Note>
  Defaults are sensible out of the box: frequentist analysis at 95% confidence, two-sided. Reach for the rest of this section when you want to peek continuously, reach significance faster, measure a ratio, estimate how much longer an experiment needs, or roll shipped wins up into a program-level impact number.
</Note>
